...
{
  //pub_twist
  ros::init(argc,argv,"nite2");
  ros::NodeHandle n_;
  geometry_msgs::Twist cmdvel_;
  ros::Publisher pub_ = n_.advertise<geometry_msgs::Twist>("cmd_vel", 100);
  //cmdvel_.linear.x = 0.1;
  //cmdvel_.angular.z = 0.1;
  //cout << "设备 " << cmdvel_ << endl;
  ...
  // p4a. check user status
    ...
    // p4b. get user skeleton
      ...
      // p4f. draw joint
          ...
          if (aJoints[7].getPosition().x-aJoints[3].getPosition().x > 0 && aJoints[7].getPosition().y-aJoints[3].getPosition().y > 0)
          {
              cmdvel_.linear.x = 0.1;
              cmdvel_.angular.z = 0.1;
          ...
          else if (aJoints[7].getPosition().x-aJoints[3].getPosition().x < 0 && aJoints[7].getPosition().y-aJoints[3].getPosition().y > 0)
          {
              cmdvel_.linear.x = 0.1;
              cmdvel_.angular.z = -0.1;
              pub_.publish(cmdvel_);
